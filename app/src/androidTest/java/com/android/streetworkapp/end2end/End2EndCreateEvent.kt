...
class End2EndCreateEvent {
     ...
     * overview screen.
     * Warning: this test fails between 00:00 and 01:00 UTC time because of the date comparison
     */
    @Test
    fun e2eCanCreateEventAndDisplayIt() {
        ...
        //Hard to invoke test functions on google markers so i fetched its location manually
        composeTestRule.onNodeWithTag("mapScreen").performTouchInput {
            click(Offset(672F, 1144F))
        }
