    ...
    if (dataPoints.isNotEmpty()) {
        ...
        Box(modifier = modifier.padding(16.dp)) {
            Canvas(
                ...
                val xTrianglePath = androidx.compose.ui.graphics.Path().apply {
                ...
                val yTrianglePath = androidx.compose.ui.graphics.Path().apply {
                ...
                for (i in 1 until dataPoints.size) {
                    ...
                    val startY = yOffset + graphHeight - ((dataPoints[i - 1].y - yMin) / (yMax - yMin)) * graphHeight
                    val endX = xOffset + xSpacing * i
                    val endY = yOffset + graphHeight - ((dataPoints[i].y - yMin) / (yMax - yMin)) * graphHeight
